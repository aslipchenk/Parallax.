...
void draw_status_lives(GameState *game)
{
    ...
    SDL_Rect rect = { 590, 350, 120, 120 };
    SDL_RenderCopyEx(renderer, game->manFrames[1], 
                    NULL, &rect, 0, NULL, (game->man.facingLeft == 1));

    SDL_SetRenderDrawColor(renderer, 255, 255, 255, 255);

    SDL_Rect textRect = { 630, 300-game->labelH/2, game->labelW, game->labelH };
    SDL_RenderCopy(renderer, game->label, NULL, &textRect);

    SDL_Rect textRect2 = { 660-game->label2W/2, 250-game->label2H/2, game->label2W, game->label2H };
...
void draw_game_over(GameState *game)
{
  ...
  SDL_Rect textRect = { 650-game->labelW/2, 240-game->labelH/2, game->labelW, game->labelH };
  SDL_RenderCopy(renderer, game->label, NULL, &textRect);
}
